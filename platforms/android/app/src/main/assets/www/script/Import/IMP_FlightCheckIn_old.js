...
$(function () {
    ...
    $("#ddlflightNoAndDate").change(function () {
        ...
        ASIforFlight(_vlaueofHawbforflight);
        //$("#txtManifested").val(Manifested);
        //$("#txtReceived").val(Received);
        //$("#txtRemaining").val(Remaining);
...
function setHungarian() {
    ...
    $('#lblManRcRem').text("Manifesztált / Érkezett / Maradék");
    $('#lblArrivedPcs').text("Érkezett darabszám");
...
function GetImportCargoCheckInDetailsOnBlure() {
...
function ASIforFlight(_vlaueofHawbforflight) {
