        ...
        success: function (response, xhr, textStatus) {
            ...
            if (str != null && str != "" && str != "<NewDataSet />") {
                ...
                $(xmlDoc).find('Table1').each(function (index) {
                    ...
                    tblArray.push({ masterno: MAWB, houseno: HAWB, mps: Remarks, pieces: 1, rowid: ISCROWID });
...
function CreateBinningListTable() {
    ...
    if (tblArray.length == 0) {
        ...
        //$('#tdMPSCount').text(countHouse.toString());
        ...
        success: function (response, xhr, textStatus) {
            ...
            if (str != null && str != "" && str != "<NewDataSet />") {
                ...
                $(xmlDoc).find('Table1').each(function (index) {
                    ...
                    if (IsAddedInGrp == "Y") {
                        tblArray.push({ masterno: "", houseno: HAWB, mps: Remarks, pieces: 1, rowid: ISCROWID1 });
                        // console.log(tblArray);
                    }
                });
